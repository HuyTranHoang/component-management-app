...
import vn.aptech.componentmanagementapp.service.*;
...
public class LoginController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Category categorise = new Category();
        categorise.setName("concuss");
        categorise.setDescription("concat");
        CategoryService categoryService = new CategoryService();
        categoryService.addCategory(categorise);
        System.out.println(categoryService + "thành công");
        Customer customer = new Customer();
        customer.setName("Bao");
        customer.setAddress("HCM");
        customer.setPhone("13465");
        customer.setEmail("@gmail.com");
        CustomerService customerService = new CustomerService();
        customerService.addCustomer(customer);
        System.out.println(customerService + "thành công");
        Department department = new Department();
        department.setName("Bao");
        department.setDescription("Hai");
        DepartmentService departmentService = new DepartmentService();
        departmentService.addDepartment(department);
        System.out.println(departmentService + "thanh cong");
        Employee employee = new Employee();
        employee.setName("Bao");
        employee.setAddress("hcm");
        employee.setPhone("0969026600");
        employee.setEmail("@gmail.com.vn");
        employee.setPassword("123");
        employee.setSalary(1234567);
        employee.setImage("132456");
        employee.setCitizenID("333456789123");
        ...
        System.out.println(employeeService + "Thanh Cong");
        Position position = new Position();
        position.setName("Bao");
        position.setDescription("123");
        PositionService positionService = new PositionService();
        positionService.addPosition(position);
        System.out.println(positionService + "Thanh COng");
        Product product = new Product();
        product.setProductCode("HNA");
        product.setName("Bao");
        product.setPrice(5555555);
        product.setMinimumPrice(1);
        product.setStockQuantity(50);
        product.setMonthOfWarranty(12);
        product.setNote("HII");
        ...
        System.out.println(productService + "thanh cong");
        Supplier supplier = new Supplier();
        supplier.setName("bao");
        supplier.setEmail("@gmail.com.vn.bao");
        supplier.setWebsite("BAOGAMINGTIVI");
        SupplierService supplierService = new SupplierService();
        supplierService.addSupplier(supplier);
        System.out.println(supplierService + "Thanh Cong");
    }
