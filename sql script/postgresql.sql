...
-- Product
-- CPU
INSERT INTO products (product_code, name, price, minimum_price, stock_quantity, month_of_warranty, note,
...
VALUES ('SNV2', 'Ổ cứng gắn trong/ SSD Kingston NV2 1000GB M.2 2280 PCIe Gen 4.0 NVMe', 1459000, 1159000, 0, 12, 'note',
        6, 2),
       ('SA400', 'Ổ cứng SSD Kingston A400 480GB Sata 3 (SA400S37/480G)', 749000, 649000, 0, 12, 'note',
        6, 2),
       ('SA2000', 'Ổ cứng SSD Kingston A2000 500GB M.2 NVMe', 1499000, 1399000, 0, 12, 'note',
        6, 2),
       ('SUV500', 'Ổ cứng SSD Kingston UV500 1TB Sata 3', 2999000, 2799000, 0, 24, 'note',
        6, 2),
       ...
       ('SSS970', 'Ổ cứng SSD Samsung 970 EVO Plus 500GB M.2 NVMe', 1599000, 1399000, 0, 12, 'note',
        8, 2),
       ('SSS860', 'Ổ cứng SSD Samsung 860 EVO 1TB Sata 3', 2899000, 2699000, 0, 36, 'note',
        8, 2),
       ...
       ('WDB001', 'Ổ cứng HDD Western Digital Blue 1TB 3.5" SATA 3 - WD10EZEX', 955000, 755000, 0, 24, 'note',
        9, 2),
       ('SSN550', 'Ổ cứng SSD Western Digital WD Blue SN550 1TB M.2 NVMe', 1999000, 1799000, 0, 12, 'note',
        9, 2),
...
INSERT INTO products (product_code, name, price, minimum_price, stock_quantity, month_of_warranty, note,
                      supplier_id, category_id)
VALUES ('MB520', 'Thùng máy/ Case CM MasterBox MB520 ARGB', 1999000, 1599000, 0, 12, 'note', 3, 3),
       ('MB05W', 'Case máy tính Cooler Master MasterBox 5 White', 1539000, 1139000, 0, 12, 'note', 3, 3),
       ('M100A', 'Thùng máy/ Case MSI MAG FORCE M100A (4 Fan RGB)', 829000, 729000, 0, 24, 'note', 7, 3),
       ...
       ('AORUSAC300G', 'Thùng máy/ Case GIGABYTE AORUS AC300G (ATX/mATX/Mini-ITX)', 2999000, 2799000, 0, 24, 'note',
        4, 3),
       ('C200G', 'Thùng máy/ Case GIGABYTE C200G (ATX/mATX/Mini-ITX)', 1799000, 1599000, 0, 12, 'note',
        4, 3),
       ('ASU100', 'Thùng máy/ Case ASUS TUF Gaming GT301 (ATX/mATX/Mini-ITX)', 1999000, 1799000, 0, 12, 'note',
        1, 3),
       ('ASU200', 'Thùng máy/ Case ASUS ROG Strix Helios (ATX/EATX)', 8999000, 8499000, 0, 24, 'note',
        1, 3),
...
VALUES ('RCMK235', 'RAM desktop CORSAIR Vengeance LPX Black Heat spreader (1 x 16GB) DDR4 3200MHz', 1249000, 1149000, 0,
       ...
       ('SAM16G3200', 'RAM desktop Samsung DDR4 16GB (1x16GB) 3200MHz', 1399000, 1299000, 0, 12, 'note',
        8, 4),
       ('SAM32G3600', 'RAM desktop Samsung DDR4 32GB (2x16GB) 3600MHz', 2999000, 2799000, 0, 24, 'note',
        8, 4),
       ('SAM8G2400', 'RAM desktop Samsung DDR4 8GB (1x8GB) 2400MHz', 699000, 599000, 0, 12, 'note',
        8, 4),
...
INSERT INTO products (product_code, name, price, minimum_price, stock_quantity, month_of_warranty, note,
                      supplier_id, category_id)
VALUES ('H510MK', 'Mainboard ASUS PRIME H510M-K', 1689000, 1489000, 0, 12, 'note', 1, 5),
       ('PRMH510', 'Mainboard ASUS PRIME H510M', 1899000, 1699000, 0, 12, 'note', 1, 5),
       ('TUFZ590', 'Mainboard ASUS TUF GAMING Z590-PLUS (WI-FI 6)', 6599000, 6399000, 0, 24, 'note', 1, 5),
       ('ROGX570', 'Mainboard ASUS ROG CROSSHAIR VIII FORMULA', 13399000, 13199000, 0, 24, 'note', 1, 5),
       ('H510MH', 'Mainboard GIGABYTE H510M-H', 1749000, 1549000, 0, 12, 'note', 4, 5),
       ('BMH410', 'Mainboard GIGABYTE B450M H', 2499000, 2299000, 0, 12, 'note', 4, 5),
       ('AZ490', 'Mainboard GIGABYTE AORUS Z490 MASTER', 10999000, 9999000, 0, 24, 'note', 4, 5),
       ('X570G', 'Mainboard GIGABYTE X570 AORUS ELITE WIFI', 6499000, 6299000, 0, 24, 'note', 4, 5),
       ('B660MA', 'Mainboard MSI PRO B660M-A WIFI DDR4', 3390000, 3090000, 0, 24, 'note', 7, 5),
       ('BMAGB460', 'Mainboard MSI MAG B460 TOMAHAWK', 3799000, 3599000, 0, 12, 'note', 7, 5),
       ('MPGB550', 'Mainboard MSI MPG B550 GAMING CARBON WIFI', 5699000, 5499000, 0, 24, 'note', 7, 5),
       ('X570MG', 'Mainboard MSI MEG X570 GODLIKE', 24999000, 23999000, 0, 24, 'note', 7, 5);
...
VALUES ('P80S', 'Nguồn máy tính Cooler Master MWE V2 - 650W - 80 Plus Bronze', 1549000, 1249000, 0, 12, 'note',
       ...
       ('PSP000157', 'Nguồn máy tính ASUS Asus Rog Thor 1200P - 1200W - 80 Plus Platinum - Full Modular (SP000157)',
        10900000, 9900000, 0, 12, 'note', 1, 6),
       ('P9020231', 'Nguồn máy tính CORSAIR CP-9020231-NA - 750W - 80 Plus Gold - Full Modular (CP-9020231-NA)',
        2990000, 2790000, 0, 24, 'note', 2, 6),
       ('PCX550F',
        'Nguồn máy tính CORSAIR CX550F RGB Black 80 Plus Bronze - 550W - 80 Plus Bronze - Full Modular (CP-9020216-NA)',
        1290000, 1090000, 0, 24, 'note', 2, 6);

-- FAN
INSERT INTO products (product_code, name, price, minimum_price, stock_quantity, month_of_warranty, note,
                      supplier_id, category_id)
VALUES ('F0E3', 'Quạt case MSI RGB 12cm Fan (OE3-7G20001-809)', 89000, 79000, 0, 12, 'note', 7, 7),
       ('FML120', 'Quạt CORSAIR ML120 RGB', 2619000, 2419000, 0, 12, 'note', 2, 7),
       ('FCM212', 'Quạt CPU CM Hyper 212 ARGB', 699000, 599000, 0, 24, 'note', 3, 7),
